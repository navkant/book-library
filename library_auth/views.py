...
from library_auth.exceptions import InvalidRefreshToken
from library_auth.models import RefreshToken, Token
...
class RefreshAuthToken(APIView):
    def post(self, request):
        ...
        try:
            refresh_token_qs = RefreshToken.objects.select_related("user").filter(
